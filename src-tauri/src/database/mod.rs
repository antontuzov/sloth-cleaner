...
pub fn save_scan(conn: &Connection, scan_id: &str, total_size: u64, file_count: u64, duration_ms: u64, categories_json: &str) -> Result<(), String> {
    conn.execute(
        ...
        (scan_id, total_size as i64, file_count as i64, duration_ms as i64, categories_json),
...
pub fn save_cleanup(conn: &Connection, cleanup_id: &str, scan_id: &str, freed_space: u64, files_deleted: u64, snapshot_id: Option<&str>, status: &str) -> Result<(), String> {
    conn.execute(
        ...
        (cleanup_id, scan_id, freed_space as i64, files_deleted as i64, snapshot_id, status),
...
pub fn record_user_decision(
    ...
    conn.execute(
        ...
        (id, file_path, file_size as i64, category, file_age_days as i64, decision, ai_score),
...
/// Get analytics data
pub fn get_analytics_data(conn: &Connection, days: u32) -> Result<Vec<(String, i64, i64, i64)>, String> {
